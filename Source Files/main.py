...
embedding_save_path = '/content/drive/My Drive/cifar_embeddings.npy'  # Path to save embeddings --- Replace with your actual path
...
save_path = '/content/drive/My Drive/vit_model.pth' #Define path to save---Replace with your actual path
...
save_path = '/content/drive/My Drive/vit_model.pth' # Replace with your actual path
...
# Specify the save path for the model
save_path = '/content/drive/My Drive/vit_model_finetuned.pth' #Replace with your actual path
...
state_dict = torch.load('/content/drive/My Drive/vit_model_finetuned.pth', map_location=device) #Replace with your actual path
